...
create index if not exists patient_assignments_workspace_id_idx on public.patient_assignments(workspace_id);
create index if not exists patient_assignments_patient_id_idx on public.patient_assignments(patient_id);
create index if not exists patient_assignments_professional_id_idx on public.patient_assignments(professional_id);
create unique index if not exists patient_assignments_active_uidx on public.patient_assignments(workspace_id, patient_id, professional_id) where ended_at is null;
