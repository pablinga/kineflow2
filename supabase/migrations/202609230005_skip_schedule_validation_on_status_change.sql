-- validate_appointment_schedule corría también cuando solo cambiaba el estado
-- (trigger BEFORE UPDATE OF ... status). Si después de crear un turno
-- particular se cargaba disponibilidad en una clínica que se superpone,
-- marcar asistencia fallaba con "Este horario está reservado para ...".
-- Ahora un cambio de estado sin cambios de horario/asignación no revalida.
-- Resto de la función: igual a la versión vigente (202609020002).
